...
import {MainMenu} from "~/utils/cons.jsx";
    ...
    return(
        ...
        <nav className="mt-0.5 mb-1">
            ...
            {MainMenu.map((menu,index) => (
                ...
                <NavLink to={menu.path} className="py-0.2 block group">
                    ...
                    {( { isActive} ) => (
                        ...
                        <div className={classNames("p-3 rounded-full transition-colors inline-flex items-center gap-5 group-hover:bg-[#eff3f41a]", {
                            ...
                            <div className="w-[26.25px] h-[26.25px] relative">
                                ...
                                {menu?.badgeCount && (
                                    <span
                                        className="w-[18px] h-[18px] rounded-full bg-[#1d9bf0] absolute -top-1.5 -right-1 flex items-center justify-center text-[11px]">{menu.badgeCount}</span>
                                )}
